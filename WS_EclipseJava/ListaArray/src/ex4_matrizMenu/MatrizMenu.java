		...
		while(op != 9) {
			...
			case 2:
				for (x=0; x < ln; x++) { // corre a matriz
					for (y=0; y < cl; y++) {
						m3[x][y] = m2[x][y] - m1[x][y]; // subtrai a matriz 1 da matriz 2 salvando na matriz 3
					}
				}
			...
			case 3:
				...
				for (x=0; x < ln; x++) { // corre a matriz
					for (y=0; y < cl; y++) {
						m1[x][y] = m1[x][y] + valor; // Soma a constante nos valores da matriz 1
						m2[x][y] = m2[x][y] + valor; // Soma a constante nos valores da matriz 2
					}
				}
